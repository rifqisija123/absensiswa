        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Data Absen SIJA</h3>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Data Absen Murid XII SIJA 2 SMK Negeri 9 Kota Bekasi</h3>
                    <div class="row mt-4">
                        <div class="col">
                    ...
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item custom-dropdown-item" href="dataabsenxsija1.php">X SIJA 1</a></li>
                        <li><a class="dropdown-item custom-dropdown-item" href="dataabsenxsija2.php">X SIJA 2</a></li>
                      </ul>
                      ...
                      <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton2">
                        <li><a class="dropdown-item custom-dropdown-item" href="dataabsenxisija1.php">XI SIJA 1</a></li>
                      </ul>
                      ...
                      <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton3">
                        <li><a class="dropdown-item custom-dropdown-item" href="dataabsenxiisija1.php">XII SIJA 1</a></li>
                        <li><a class="dropdown-item custom-dropdown-item" href="dataabsenxiisija2.php">XII SIJA 2</a></li>
                      </ul>
                    </div>
                    <a href="export-absenxiisija2.php" class="btn btn-outline-secondary mt-3">Export</a>
                  </div>
                  <div class="card-body">
                       ...
                       <tbody>
                        ...
                        if (isset($_POST['submit_tanggal'])) {
                          ...
                          if (!empty($tanggal)) {
                            ...
                            $ambilsemuadataabsenxiisija2 = mysqli_query($conn, "SELECT * FROM dataabsenxiisija2 WHERE tanggalabsen = '$tanggal'");
                          } else {
                            // Query untuk menampilkan semua data jika tanggal kosong
                            $ambilsemuadataabsenxiisija2 = mysqli_query($conn, "SELECT * FROM dataabsenxiisija2");
                          }
                        } else {
                          ...
                          while($data=mysqli_fetch_array($ambilsemuadataabsenxiisija2)){

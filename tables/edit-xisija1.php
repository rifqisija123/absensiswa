...
$query = "SELECT * FROM dataxisija1 WHERE iddatasija = $id";
        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="mb-3">Edit Data Murid XI SIJA 1</h3>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <form action="dataxisija1.php" method="post">
                        <div class="modal-body">
                            ...
                            <button type="submit" class="btn btn-primary" name="editxisija1" value="Upload">Submit</button>

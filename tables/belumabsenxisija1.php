        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Data Murid XI SIJA belum absen</h3>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Data Murid XI SIJA belum absen</h3>
                    <div class="dropdown">
                      ...
                      <a href="export-belumabsenxisija1.php" class="btn btn-secondary ml-1">Export</a>
                    </div>
                  </div>
                  <div class="card-body">
                      ...
                      <table
                       ...
                       <tbody>
                        ...
                        <tr>
                          ...
                          <td><?=$jurusan;?></td>
                          <td>
                            <form method="post" action="../validasi-xisija1.php">
                                <input type="hidden" name="uidxisija1" value="<?=$uid;?>">
                                <input type="hidden" name="namalengkapxisija1" value="<?=$namalengkap;?>">
                                <input type="hidden" name="kelasxisija1" value="<?=$kelas;?>">
                                <input type="hidden" name="jurusanxisija1" value="<?=$jurusan;?>">
                                <button type="submit" name="absenxisija1" value="Hadir" class="btn btn-success">Hadir</button>
                                <button type="submit" name="absenxisija1" value="Izin" class="btn btn-info">Izin</button>
                                <button type="submit" name="absenxisija1" value="Sakit" class="btn btn-warning">Sakit</button>
                            </form>
                          </td>
                        </tr>
                        <?php

              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <a href="add-xiisija2.php" class="btn btn-primary"><i class="fa fa-plus">Tambah Data Siswa</i></a>
                    <a href="export-xiisija2.php" class="btn btn-secondary ml-1">Export</a>
                    <div class="dropdown">
                      ...
                      <table
                       ...
                       <tbody>
                        ...
                        <tr>
                          ...
                          <td><?=$jurusan;?></td>
                          <td>
                            <a href="edit-xiisija2.php?id=<?=$iddatasija;?>" class="btn btn-primary"><i class="fa fa-edit">Edit</i></a>

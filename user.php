          ...
          <ul class="nav nav-secondary">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="base">
                <ul class="nav nav-collapse">
                  <li>
                    <a href="pages_users/data-sija.php">
                      <span class="sub-item">Data SIJA</span>
                    </a>
                  </li>
                  <li>
                    <a href="pages_users/data-absen-sija.php">
                      <span class="sub-item">Rekap Absen SIJA</span>
                    </a>
                  </li>
                  <li>
                    <a href="pages_users/log-sija.php">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebarLayouts">
                <ul class="nav nav-collapse">
                  <li>
                    <a href="pages_users/data-dkv.php">
                      <span class="sub-item">Data DKV</span>
                    </a>
                  </li>
                  <li>
                    <a href="pages_users/data-absen-dkv.php">
                      <span class="sub-item">Rekap Absen DKV</span>
                    </a>
                  </li>
                  <li>
                    <a href="pages_users/log.dkv.php">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="forms">
                <ul class="nav nav-collapse">
                  <li>
                    <a href="pages_users/data-lpb.php">
                      <span class="sub-item">Data LPB</span>
                    </a>
                  </li>
                  <li>
                    <a href="pages_users/data-absen-lpb.php">
                      <span class="sub-item">Rekap Absen LPB</span>
                    </a>
                  </li>
                  <li>
                    <a href="pages_users/log-lpb.php">

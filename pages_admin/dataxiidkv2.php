    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="fw-bold mb-3">Data Murid XII DKV 2</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <a href="add-xiidkv2.php" class="btn btn-primary"><i class="fa fa-plus">Tambah Data Siswa</i></a>
                <a href="../export/export-xiidkv2.php" class="btn btn-secondary ml-1">Export</a>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item custom-dropdown-item" href="dataxdkv1.php">X DKV 1</a></li>
                    <li><a class="dropdown-item custom-dropdown-item" href="dataxdkv2.php">X DKV 2</a></li>
                    <li><a class="dropdown-item custom-dropdown-item" href="dataxdkv3.php">X DKV 3</a></li>
                  </ul>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton2">
                    <li><a class="dropdown-item custom-dropdown-item" href="dataxidkv1.php">XI DKV 1</a></li>
                    <li><a class="dropdown-item custom-dropdown-item" href="dataxidkv2.php">XI DKV 2</a></li>
                    <li><a class="dropdown-item custom-dropdown-item" href="dataxidkv3.php">XI DKV 3</a></li>
                  </ul>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton3">
                    <li><a class="dropdown-item custom-dropdown-item" href="dataxiidkv1.php">XII DKV 1</a></li>
                    <li><a class="dropdown-item custom-dropdown-item" href="dataxiidkv2.php">XII DKV 2</a></li>
                    <li><a class="dropdown-item custom-dropdown-item" href="dataxiidkv3.php">XII DKV 3</a></li>
                  </ul>
                </div>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table
                    ...
                    <tbody>
                      <?php
                      $ambilsemuadataxiidkv2 = mysqli_query($conn, "SELECT * FROM dataxiidkv2");
                      while ($data = mysqli_fetch_array($ambilsemuadataxiidkv2)) {
                        $uid = $data['uid'];
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $jurusan; ?></td>
                          <td>
                            <a href="edit-xiidkv2.php?id=<?= $iddatadkv; ?>" class="btn btn-primary"><i class="fa fa-edit">Edit</i></a>
                            <button type="button" data-id="<?= $iddatadkv; ?>" class="btn btn-danger btn-hapus" data-toggle="modal" data-target="#delete<?= $iddatadkv; ?>"><i class="fa fa-trash"></i>
                              Delete
                            </button>
                          </td>
                        </tr>
        ...
        button.addEventListener('click', function() {
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              $.ajax({
                url: '../hapus_data/fungsi_hapusxiidkv2.php', // Ganti dengan URL ke skrip PHP penghapus
                type: 'POST',
                data: {
                  id: itemId
                },

...
<body>
              ...
              <div class="card-header">
                <form id="addForm">
                  <div class="modal-body">
                    <div class="form-group"><label class="form-label fw-bold">Email</label><input type="email" name="email" id="email" placeholder="Masukkan Email" class="form-control" required></div>
                    <div class="form-group"><label class="form-label fw-bold">Password</label><input type="password" name="password" id="password" placeholder="Masukkan Password" class="form-control" required></div>
                    <div class="form-group"><label class="form-label fw-bold">Role</label><select name="role" id="role" class="form-control" required>
                    ...
                    <br>
                    <br>
                    <button type="submit" class="btn btn-primary" name="add-user-management">Submit</button>
                    <a href="user-management.php" class="btn btn-danger">Batal</a>
                  </div>
                </form>
              </div>
            </div>
  ...
  <script>
    document.getElementById('addForm').addEventListener('submit', function(event) {
      ...
      fetch('../tambah_data/add-user-management.php', {
          method: 'POST',
          body: formData
        })
        ...
        .then(result => {
          ...
          if (data.success) {
            Swal.fire({
              ...
              window.location.href = 'user-management.php'; // Redirect ke halaman dataxiisija1.php
            });
          } else {
            Swal.fire({

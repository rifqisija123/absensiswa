    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="fw-bold mb-3">Data Murid XI DKV 3 belum absen</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Murid XI DKV 3 belum absen</h3>
                <div class="dropdown">
                  ...
                  <a href="../export/export-belumabsenxidkv3.php" class="btn btn-secondary ml-1">Export</a>
                </div>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table
                    ...
                    <tbody>
                      ...
                      $ambilsemuadataxidkv3 = mysqli_query(
                        $conn,
                        "SELECT * FROM dataxidkv3
                            WHERE uid NOT IN 
                            (SELECT uid FROM dataabsenxidkv3 WHERE tanggalabsen = '$tanggalsekarang')"
                      );
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $jurusan; ?></td>
                          <td>
                            <form method="post" action="../vendor/input/endpoint-xidkv3.php">
                              <input type="hidden" name="uidxidkv3" value="<?= $uid; ?>">
                              <input type="hidden" name="namalengkapxidkv3" value="<?= $namalengkap; ?>">
                              <input type="hidden" name="kelasxidkv3" value="<?= $kelas; ?>">
                              <input type="hidden" name="jurusanxidkv3" value="<?= $jurusan; ?>">
                              <button type="submit" name="absenxidkv3" value="Hadir" class="btn btn-success">Hadir</button>
                              <button type="submit" name="absenxidkv3" value="Izin" class="btn btn-info">Izin</button>
                              <button type="submit" name="absenxidkv3" value="Sakit" class="btn btn-warning">Sakit</button>
                            </form>
                          </td>
                        </tr>
                      <?php

...
<body>
    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="mb-3">Tambah Data Murid XII DKV 2</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <form id="addForm">
                  <div class="modal-body">
                    ...
                    <br>
                    <br>
                    <button type="submit" class="btn btn-primary" name="addxiidkv2">Submit</button>
  ...
  <script>
    document.getElementById('addForm').addEventListener('submit', function(event) {
      ...
      fetch('../tambah_data/fungsi_addxiidkv2.php', {
          method: 'POST',
          body: formData
        })
        ...
        .then(result => {
          ...
          if (data.success) {
            Swal.fire({
              ...
              window.location.href = 'dataxiidkv2.php'; // Redirect ke halaman dataxiisija1.php
            });
          } else {
            Swal.fire({

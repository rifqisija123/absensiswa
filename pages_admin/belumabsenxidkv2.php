    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="fw-bold mb-3">Data Murid XI DKV 2 belum absen</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Murid XI DKV 2 belum absen</h3>
                <div class="dropdown">
                  ...
                  <a href="../export/export-belumabsenxidkv2.php" class="btn btn-secondary ml-1">Export</a>
                </div>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table
                    ...
                    <tbody>
                      ...
                      $ambilsemuadataxidkv2 = mysqli_query(
                        $conn,
                        "SELECT * FROM dataxidkv2
                            WHERE uid NOT IN 
                            (SELECT uid FROM dataabsenxidkv2 WHERE tanggalabsen = '$tanggalsekarang')"
                      );
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $jurusan; ?></td>
                          <td>
                            <form method="post" action="../vendor/input/endpoint-xidkv2.php">
                              <input type="hidden" name="uidxidkv2" value="<?= $uid; ?>">
                              <input type="hidden" name="namalengkapxidkv2" value="<?= $namalengkap; ?>">
                              <input type="hidden" name="kelasxidkv2" value="<?= $kelas; ?>">
                              <input type="hidden" name="jurusanxidkv2" value="<?= $jurusan; ?>">
                              <button type="submit" name="absenxidkv2" value="Hadir" class="btn btn-success">Hadir</button>
                              <button type="submit" name="absenxidkv2" value="Izin" class="btn btn-info">Izin</button>
                              <button type="submit" name="absenxidkv2" value="Sakit" class="btn btn-warning">Sakit</button>
                            </form>
                          </td>
                        </tr>
                      <?php

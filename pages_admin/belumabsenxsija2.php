            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="dropdown">
                  ...
                  <a href="../export/export-belumabsenxsija2.php" class="btn btn-secondary ml-1">Export</a>
                </div>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table
                    ...
                    <tbody>
                      ...
                      $ambilsemuadataxsija2 = mysqli_query(
                        $conn,
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $jurusan; ?></td>
                          <td>
                            <form method="post" action="../vendor/input/endpoint-xsija2.php">

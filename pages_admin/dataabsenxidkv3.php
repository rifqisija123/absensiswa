          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Absen Murid XI DKV 3 SMK Negeri 9 Kota Bekasi</h3>
                <div class="row mt-4">
                  <div class="col">
                ...
                <a href="../export/export-absenxidkv3.php" class="btn btn-outline-secondary mt-3">Export</a>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                      ...
                      if (isset($_POST['submit_tanggal'])) {
                        ...
                        if (!empty($tanggal)) {
                          ...
                          $ambilsemuadataabsenxidkv3 = mysqli_query($conn, "SELECT * FROM dataabsenxidkv3 WHERE tanggalabsen = '$tanggal'");
                        } else {
                          // Query untuk menampilkan semua data jika tanggal kosong
                          $ambilsemuadataabsenxidkv3 = mysqli_query($conn, "SELECT * FROM dataabsenxidkv3");
                        }
                      } else {
                      ...
                      while ($data = mysqli_fetch_array($ambilsemuadataabsenxidkv3)) {

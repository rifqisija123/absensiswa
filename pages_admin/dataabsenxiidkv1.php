    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="fw-bold mb-3">Data Absen DKV</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Absen Murid XII DKV 1 SMK Negeri 9 Kota Bekasi</h3>
                <div class="row mt-4">
                  <div class="col">
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item custom-dropdown-item" href="dataabsenxdkv1.php">X DKV 1</a></li>
                    <li><a class="dropdown-item custom-dropdown-item" href="dataabsenxdkv2.php">X DKV 2</a></li>
                    <li><a class="dropdown-item custom-dropdown-item" href="dataabsenxdkv3.php">X DKV 3</a></li>
                  </ul>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton2">
                    <li><a class="dropdown-item custom-dropdown-item" href="dataabsenxidkv1.php">XI DKV 1</a></li>
                    <li><a class="dropdown-item custom-dropdown-item" href="dataabsenxidkv2.php">XI DKV 2</a></li>
                    <li><a class="dropdown-item custom-dropdown-item" href="dataabsenxidkv3.php">XI DKV 3</a></li>
                  </ul>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton3">
                    <li><a class="dropdown-item custom-dropdown-item" href="dataabsenxiidkv1.php">XII DKV 1</a></li>
                    <li><a class="dropdown-item custom-dropdown-item" href="dataabsenxiidkv2.php">XII DKV 2</a></li>
                    <li><a class="dropdown-item custom-dropdown-item" href="dataabsenxiidkv3.php">XII DKV 3</a></li>
                  </ul>
                </div>
                <a href="../export/export-absenxiidkv1.php" class="btn btn-outline-secondary mt-3">Export</a>
              </div>
              <div class="card-body">
                  ...
                  <table
                    ...
                    <tbody>
                      ...
                      if (isset($_POST['submit_tanggal'])) {
                        ...
                        if (!empty($tanggal)) {
                          // Query untuk memfilter berdasarkan tanggal
                          $ambilsemuadataabsenxiidkv1 = mysqli_query($conn, "SELECT * FROM dataabsenxiidkv1 WHERE tanggalabsen = '$tanggal'");
                        } else {
                          // Query untuk menampilkan semua data jika tanggal kosong
                          $ambilsemuadataabsenxiidkv1 = mysqli_query($conn, "SELECT * FROM dataabsenxiidkv1");
                        }
                      } else {
                      ...
                      while ($data = mysqli_fetch_array($ambilsemuadataabsenxiidkv1)) {

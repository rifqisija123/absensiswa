...
$query = "SELECT * FROM dataxiidkv1 WHERE iddatadkv = $id";
    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="mb-3">Edit Data Murid XII DKV 1</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <form action="dataxiidkv1.php" method="post">
                  <div class="modal-body">
                    ...
                    <br>
                    <br>
                    <input type="hidden" name="iddatadkv" value="<?= $data['iddatadkv']; ?>">
                    <button type="submit" class="btn btn-primary" name="editxiidkv1" value="Upload">Submit</button>
                    <a href="dataxiidkv1.php" class="btn btn-danger">Batal</a>
                  </div>
                </form>
              </div>
            </div>

    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="fw-bold mb-3">Data Murid XII DKV 2 belum absen</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Murid XII DKV 2 belum absen</h3>
                <div class="dropdown">
                  ...
                  <a href="../export/export-belumabsenxiidkv2.php" class="btn btn-secondary ml-1">Export</a>
                </div>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table
                    ...
                    <tbody>
                      ...
                      $ambilsemuadataxiidkv2 = mysqli_query(
                        $conn,
                        "SELECT * FROM dataxiidkv2
                            WHERE uid NOT IN 
                            (SELECT uid FROM dataabsenxiidkv2 WHERE tanggalabsen = '$tanggalsekarang')"
                      );
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $jurusan; ?></td>
                          <td>
                            <form method="post" action="../vendor/input/endpoint-xiidkv2.php">
                              <input type="hidden" name="uidxiidkv2" value="<?= $uid; ?>">
                              <input type="hidden" name="namalengkapxiidkv2" value="<?= $namalengkap; ?>">
                              <input type="hidden" name="kelasxiidkv2" value="<?= $kelas; ?>">
                              <input type="hidden" name="jurusanxiidkv2" value="<?= $jurusan; ?>">
                              <button type="submit" name="absenxiidkv2" value="Hadir" class="btn btn-success">Hadir</button>
                              <button type="submit" name="absenxiidkv2" value="Izin" class="btn btn-info">Izin</button>
                              <button type="submit" name="absenxiidkv2" value="Sakit" class="btn btn-warning">Sakit</button>
                            </form>
                          </td>
                        </tr>
                      <?php

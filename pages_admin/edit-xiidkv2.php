...
$query = "SELECT * FROM dataxiidkv2 WHERE iddatadkv = $id";
    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="mb-3">Edit Data Murid XII DKV 2</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <form action="dataxiidkv2.php" method="post">
                  <div class="modal-body">
                    ...
                    <button type="submit" class="btn btn-primary" name="editxiidkv2" value="Upload">Submit</button>
                    <a href="dataxiidkv2.php" class="btn btn-danger">Batal</a>
                  </div>
                </form>
              </div>
            </div>

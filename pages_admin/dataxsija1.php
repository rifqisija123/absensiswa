    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="fw-bold mb-3">Data Murid X SIJA 1</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <a href="add-xsija1.php" class="btn btn-primary"><i class="fa fa-plus">Tambah Data Siswa</i></a>
                <a href="../export/export-xsija1.php" class="btn btn-secondary ml-1">Export</a>
                <div class="dropdown">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $jurusan; ?></td>
                          <td>
                            <a href="edit-xsija1.php?id=<?= $iddatasija; ?>" class="btn btn-primary"><i class="fa fa-edit">Edit</i></a>
        ...
        button.addEventListener('click', function() {
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              $.ajax({
                url: '../hapus_data/fungsi_hapusxsija1.php', // Ganti dengan URL ke skrip PHP penghapus
                type: 'POST',
                data: {
                  id: itemId
                },

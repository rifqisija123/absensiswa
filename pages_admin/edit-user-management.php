              ...
              <div class="card-header">
                <form action="user-management.php" method="post">
                  <div class="modal-body">
                    <div class="form-group"><label class="form-label fw-bold">Email</label><input type="email" name="email" id="email" class="form-control" value="<?= $data['email']; ?>" required></div>
                    <div class="form-group"><label class="form-label fw-bold">Password</label><input type="password" name="password" id="password" class="form-control" value="<?= $data['password']; ?>" required></div>
                    <div class="form-group"><label class="form-label fw-bold">Role</label><select name="role" id="role" class="form-control" value="<?= $data['role']; ?>" required>
                    ...
                    <button type="submit" class="btn btn-primary" name="edit-user-management" value="Upload">Submit</button>

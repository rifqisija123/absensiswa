    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="fw-bold mb-3">Data Murid X DKV 3 belum absen</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Murid X DKV 3 belum absen</h3>
                <div class="dropdown">
                  ...
                  <a href="../export/export-belumabsenxdkv3.php" class="btn btn-secondary ml-1">Export</a>
                </div>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table
                    ...
                    <tbody>
                      ...
                      $ambilsemuadataxdkv3 = mysqli_query(
                        $conn,
                        "SELECT * FROM dataxdkv3
                            WHERE uid NOT IN 
                            (SELECT uid FROM dataabsenxdkv3 WHERE tanggalabsen = '$tanggalsekarang')"
                      );
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $jurusan; ?></td>
                          <td>
                            <form method="post" action="../vendor/input/endpoint-xdkv3.php">
                              <input type="hidden" name="uidxdkv3" value="<?= $uid; ?>">
                              <input type="hidden" name="namalengkapxdkv3" value="<?= $namalengkap; ?>">
                              <input type="hidden" name="kelasxdkv3" value="<?= $kelas; ?>">
                              <input type="hidden" name="jurusanxdkv3" value="<?= $jurusan; ?>">
                              <button type="submit" name="absenxdkv3" value="Hadir" class="btn btn-success">Hadir</button>
                              <button type="submit" name="absenxdkv3" value="Izin" class="btn btn-info">Izin</button>
                              <button type="submit" name="absenxdkv3" value="Sakit" class="btn btn-warning">Sakit</button>
                            </form>
                          </td>
                        </tr>
                      <?php

                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="add-user-management.php" class="btn btn-primary"><i class="fa fa-plus">Tambah User
                                        Baru</i>
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example-table" class="display table table-striped table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            $usermanagement = mysqli_query($conn, "select * from users");
                                            while ($data = mysqli_fetch_array($usermanagement)) {
                                                $id = $data['id'];
                                                $email = $data['email'];
                ...
                button.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                url: '../hapus_data/del-user-management.php', // Ganti dengan URL ke skrip PHP penghapus
                                type: 'POST',
                                data: {
                                    id: itemId
                                },

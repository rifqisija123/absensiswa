...
$query = "SELECT * FROM dataxiidkv3 WHERE iddatadkv = $id";
    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="mb-3">Edit Data Murid XII DKV 3</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <form action="dataxiidkv3.php" method="post">
                  <div class="modal-body">
                    ...
                    <button type="submit" class="btn btn-primary" name="editxiidkv3" value="Upload">Submit</button>
                    <a href="dataxiidkv3.php" class="btn btn-danger">Batal</a>
                  </div>
                </form>
              </div>
            </div>

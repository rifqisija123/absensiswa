...
<body>
    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="mb-3">Tambah Data Murid X DKV 3</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <form id="addForm">
                  <div class="modal-body">
                    ...
                    <br>
                    <br>
                    <button type="submit" class="btn btn-primary" name="addxdkv3">Submit</button>
  ...
  <script>
    document.getElementById('addForm').addEventListener('submit', function(event) {
      ...
      fetch('../tambah_data/fungsi_addxdkv3.php', {
          method: 'POST',
          body: formData
        })
        ...
        .then(result => {
          ...
          if (data.success) {
            Swal.fire({
              ...
              window.location.href = 'dataxdkv3.php'; // Redirect ke halaman dataxiisija1.php
            });
          } else {
            Swal.fire({

    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="fw-bold mb-3">Data Murid X DKV 1</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <a href="add-xdkv1.php" class="btn btn-primary"><i class="fa fa-plus">Tambah Data Siswa</i></a>
                <a href="../export/export-xdkv1.php" class="btn btn-secondary ml-1">Export</a>
                <div class="dropdown">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table
                    ...
                    <tbody>
                      <?php
                      $ambilsemuadataxdkv1 = mysqli_query($conn, "SELECT * FROM dataxdkv1");
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $jurusan; ?></td>
                          <td>
                            <a href="edit-xdkv1.php?id=<?= $iddatadkv; ?>" class="btn btn-primary"><i class="fa fa-edit">Edit</i></a>
        ...
        button.addEventListener('click', function() {
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              $.ajax({
                url: '../hapus_data/fungsi_hapusxdkv1.php', // Ganti dengan URL ke skrip PHP penghapus
                type: 'POST',
                data: {
                  id: itemId
                },

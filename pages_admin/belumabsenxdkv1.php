            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="dropdown">
                  ...
                  <a href="../export/export-belumabsenxdkv1.php" class="btn btn-secondary ml-1">Export</a>
                </div>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $jurusan; ?></td>
                          <td>
                            <form method="post" action="../vendor/input/endpoint-xdkv1.php">
                              <input type="hidden" name="uidxdkv1" value="<?= $uid; ?>">
                              <input type="hidden" name="namalengkapxdkv1" value="<?= $namalengkap; ?>">
                              <input type="hidden" name="kelasxdkv1" value="<?= $kelas; ?>">
                              <input type="hidden" name="jurusanxdkv1" value="<?= $jurusan; ?>">
                              <button type="submit" name="absenxdkv1" value="Hadir" class="btn btn-success">Hadir</button>
                              <button type="submit" name="absenxdkv1" value="Izin" class="btn btn-info">Izin</button>
                              <button type="submit" name="absenxdkv1" value="Sakit" class="btn btn-warning">Sakit</button>
                            </form>
                          </td>
                        </tr>
                      <?php

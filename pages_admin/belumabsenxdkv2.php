    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="fw-bold mb-3">Data Murid X DKV 2 belum absen</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Murid X DKV 2 belum absen</h3>
                <div class="dropdown">
                  ...
                  <a href="../export/export-belumabsenxdkv2.php" class="btn btn-secondary ml-1">Export</a>
                </div>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table
                    ...
                    <tbody>
                      ...
                      $ambilsemuadataxdkv2 = mysqli_query(
                        $conn,
                        "SELECT * FROM dataxdkv2
                            WHERE uid NOT IN 
                            (SELECT uid FROM dataabsenxdkv2 WHERE tanggalabsen = '$tanggalsekarang')"
                      );
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $jurusan; ?></td>
                          <td>
                            <form method="post" action="../vendor/input/endpoint-xdkv2.php">
                              <input type="hidden" name="uidxdkv2" value="<?= $uid; ?>">
                              <input type="hidden" name="namalengkapxdkv2" value="<?= $namalengkap; ?>">
                              <input type="hidden" name="kelasxdkv2" value="<?= $kelas; ?>">
                              <input type="hidden" name="jurusanxdkv2" value="<?= $jurusan; ?>">
                              <button type="submit" name="absenxdkv2" value="Hadir" class="btn btn-success">Hadir</button>
                              <button type="submit" name="absenxdkv2" value="Izin" class="btn btn-info">Izin</button>
                              <button type="submit" name="absenxdkv2" value="Sakit" class="btn btn-warning">Sakit</button>
                            </form>
                          </td>
                        </tr>
                      <?php

...
<body>
    ...
    <div class="container">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="mb-3">Tambah Data Murid XII DKV 3</h3>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
  ...
  <script>
    document.getElementById('addForm').addEventListener('submit', function(event) {
      ...
      fetch('../tambah_data/fungsi_addxiidkv3.php', {
          method: 'POST',
          body: formData
        })
        ...
        .then(result => {
          ...
          if (data.success) {
            Swal.fire({
              ...
              window.location.href = 'dataxiidkv3.php'; // Redirect ke halaman dataxiisija1.php
            });
          } else {
            Swal.fire({
